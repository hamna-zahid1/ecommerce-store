          ...
          <div className="space-y-4 lg:space-y-6">
            <div className="space-y-2.5">
              <div className="flex-between text-gray-dark dark:text-light">
                ...
                <p>
                  Listed on{" "}
                  <strong className="font-medium">{formatDate(product.createdAt)}</strong>
                </p>
              </div>
              <div className="flex-between">
                <h3 className="text-3xl lg:text-4xl dark:text-light text-gray font-bold transition">
                  {product.name}
                </h3>
            ...
            {productBelongsToUser ? (
              <div className="space-x-2">
                <NavLink to={`/products/edit/${productId}`}>
                  <button className="btn bg-emerald-500 border-emerald-500 py-2 font-medium">
                    Edit
                  </button>
                </NavLink>
                <button
